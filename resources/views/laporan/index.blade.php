        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <button type="submit" name="buatLaporan" class="btn btn-md btn-primary">Buat Laporan</button>
                    <button type="submit" name="exportExcel" class="btn btn-md btn-success">Export Excel</button>
