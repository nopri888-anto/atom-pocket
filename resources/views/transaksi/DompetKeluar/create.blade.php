...
<div class="row">
    <div class="col-md-6">
        <h1 class="h3 mb-4 text-gray-800">Buat Transaksi Keluar</h1>
    </div>
    <div class="col-md-6 text-right">
        <a href="{{route('dompetKeluar.index')}}" type="button" class="btn btn-primary">Kelola Transaksi Keluar</a>
    </div>
</div>
...
<div class="card-body p-0 border-all-primary">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="p-5">
                <form method="POST" action="{{route('dompetKeluar.store')}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
